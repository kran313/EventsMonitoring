...
namespace EventsMonitoring.CommonClasses
{
    ...
    {
        private static string _connectionString = "data source=srvapkbb9.gkbaltbet.local;initial catalog=EventMatching;user Id=event_match;password=umbMzLQB3hKo69VG8F4N;" +
